...
(function withAngular(angular) {
  ...
  var directiveName = 'socialshare'
    ...
    , manageFacebookShare = function manageFacebookShare($window, attrs) {
      ...
      if (attrs.socialshareType && attrs.socialshareType === 'feed') {
       ...
       if (attrs.socialshareHashtags) {
        ...
        urlString = 'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href);
      }
    ...
    , manageGooglePlusShare = function manageGooglePlusShare($window, attrs) {
      return 'https://plus.google.com/share?url=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href);
    ...
    , manageRedditShare = function manageRedditShare($window, attrs) {
      ...
      */
      ...
      return urlString + encodeURIComponent(attrs.socialshareUrl || $window.location.href) + '&title=' + encodeURIComponent(attrs.socialshareText);

    , manageStumbleuponShare = function manageStumbleuponShare($window, attrs) {
      return 'https://www.stumbleupon.com/submit?url=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href) + '&title=' + encodeURIComponent(attrs.socialshareText)
    }
    ...
    , managePinterestShare = function managePinterestShare($window, attrs) {
      return 'https://www.pinterest.com/pin/create/button/?url=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href) + '&media=' + encodeURIComponent(attrs.socialshareMedia) + '&description=' + encodeURIComponent(attrs.socialshareText);
    }
    , manageDiggShare = function manageDiggShare($window, attrs) {
      return 'https://www.digg.com/submit?url=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href) + '&title=' + encodeURIComponent(attrs.socialshareText);
    }
    , manageTumblrShare = function manageTumblrShare($window, attrs) {
      ...
      if (attrs.socialshareMedia) {
        ...
        return 'https://www.tumblr.com/share/link?url=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href) + '&description=' + encodeURIComponent(attrs.socialshareText);
    ...
    , manageOkShare = function manageOkShare($window, attrs) {
      return 'http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st._surl=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href) + '&st.comments=' + encodeURIComponent(attrs.socialshareText);
    }
    , manageDeliciousShare = function manageDeliciousShare($window, attrs) {
      return 'https://www.delicious.com/save?v=5&noui&jump=close&url=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href) + '&title=' + encodeURIComponent(attrs.socialshareText)
    }
    ...
    , manageXingShare = function manageXingShare($window, attrs) {
      ...
      return 'https://www.xing.com/spi/shares/new?url=' + encodeURIComponent(attrs.socialshareUrl || $window.location.href) + followUrl;
    }
    ...
    , socialshareService = /*@ngInject*/  ['$window', '$log', function socialshareService($window, $log) {
      ...
      this.share = function shareTrigger(serviceShareConf) {
        ...
        switch (serviceShareConf.provider) {
          case 'email': {
            return this.emailShare($window, serviceShareConf.attrs);
          }
          case 'sms': {
            return this.smsShare($window, $log, serviceShareConf.attrs);
          }
          case 'facebook': {
            return this.facebookShare($window, serviceShareConf.attrs);
          }
          case 'twitter': {
            return this.twitterShare($window, serviceShareConf.attrs);
          }
          case 'pinterest': {
            return this.pinterestShare($window, serviceShareConf.attrs);
          }
          case 'ok': {
            return this.okShare($window, serviceShareConf.attrs);
          }
          case 'vk': {
            return this.vkShare($window, serviceShareConf.attrs);
          }
          case 'delicious': {
            return this.deliciousShare($window, serviceShareConf.attrs);
          }
          case 'digg': {
            return this.diggShare($window, serviceShareConf.attrs);
          }
          case 'google': {
            return this.googleShare($window, serviceShareConf.attrs);
          }
          case 'reddit': {
            return this.redditShare($window, serviceShareConf.attrs);
          }
          case 'hackernews': {
            return this.hackernewsShare($window, serviceShareConf.attrs);
          }
          case 'skype': {
            return this.skypeShare($window, serviceShareConf.attrs);
          }
          case 'evernote': {
            return this.evernoteShare($window, serviceShareConf.attrs);
          }
          case 'pocket': {
            return this.pocketShare($window, serviceShareConf.attrs);
          }
          case 'tumblr': {
            return this.tumblrShare($window, serviceShareConf.attrs);
          }
          case 'telegram': {
            return this.telegramShare($window, serviceShareConf.attrs);
          }
          case 'xing': {
            return this.xingShare($window, serviceShareConf.attrs);
          }
          case 'buffer': {
            return this.bufferShare($window, serviceShareConf.attrs);
          }
          case 'stumbleupon': {
            return this.stumbleuponShare($window, serviceShareConf.attrs);
          }
          case 'linkedin': {
            return this.linkedinShare($window, serviceShareConf.attrs);
          }
          case 'wordpress': {
            return this.wordpressShare($window, serviceShareConf.attrs);
          }
          case 'flipboard': {
            return this.flipboardShare($window, serviceShareConf.attrs);
          }
          case 'weibo': {
            return this.weiboShare($window, serviceShareConf.attrs);
          }
          default: {
            return;
          }
